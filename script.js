...
(function () {
  ...
  function drawCard(forcedIndex, fromHistory) {
    ...
    // На старте карта дня показывается автоматически: не выдаём звук за звук
    // заставки. После полной инициализации canBuzz становится true, и обычные
    // действия пользователя снова получают свои мягкие отклики.
    if (!fromHistory && canBuzz) {
